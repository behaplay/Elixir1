...
const Carusel = () => {
    return (
        <Carousel
            autoplay="true"
            loop
            className="mx-auto container mt-20 rounded-xl bg-gray-200 w-[70%]">
            <div className="flex animate-fade-up duration-300 flex-col md:flex-row justify-center items-center gap-10 my-4 px-1">
            ...
            <div className="flex animate-fade-up duration-300 flex-col md:flex-row justify-center items-center gap-10 my-4 px-4">
